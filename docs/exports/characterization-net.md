...
`@gokayo43/dev-config/characterization-net` is the harness under a golden —
...
```ts
import { assertNet, rebaselineNet, type Net } from "@gokayo43/dev-config/characterization-net";
